  ...
  return (
    <main className="prose font-bold text-black w-full">
      ...
      <p>
        ...
        little bit there tho ngl).
      </p>
      <p>
        Let&apos;s go back to 2015 where it all started. I read some novels and
      ...
      <p>
        ...
        hobby(among other things as well).
      </p>
      <p>
        However I&apos;m at a better place and in the pursuit of finding my own
      ...
      <p>
        ...
        tunnel of life, where I&apos;m always glad to have some like-minded
        company.
      </p>
      <p className="italic">If that sounds like you, welcome!</p>
    </main>
  );
};
